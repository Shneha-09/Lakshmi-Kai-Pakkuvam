    ...
    >
      <nav className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <Link href="/" className="flex flex-col leading-tight">
          <span className="font-serif text-xl font-bold text-brown-800">Lakshmi</span>
          <span className="text-xs font-semibold tracking-widest text-gold-500 uppercase">Kai Pakkuvam</span>
        </Link>
